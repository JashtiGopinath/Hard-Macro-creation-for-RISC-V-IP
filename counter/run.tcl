...
create_lib -technology $TECH_FILE -ref_libs $REFERENCE_LIBRARY counter.nlib

analyze -format verilog [glob rtl/*.v]

elaborate machine_counter

set_top_module machine_counter

source scripts/tech_setup.tcl

load_upf ./design_data/counter.upf
commit_upf

source ./design_data/counter_constraints.tcl
...
create_abstract
create_frame
write_gds -allow_design_mistach ../results/alu.gds
